void Print_Test_Menu_PIXHAWK() {  
  ...
  DOWN1_BTN.initButton(&tft, Button_X2, Button_Y2, Button_W, Button_H, WHITE, RED, WHITE, "DISARM", 2);  
  ...
  //Arm PIXHAWK Mission
   ...
   OPTION1_BTN.initButton(&tft, Button_X3, 250, 200, 60, WHITE, GREEN, BLACK, "ARM", 2);
