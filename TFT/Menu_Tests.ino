...
void Print_Tests_Menu() {
   tft.fillScreen(BLACK);
    ...
    Test1_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, YELLOW, YELLOW, BLACK, "Wire >", 2);
    ...
    Test2_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, WHITE, BLACK, "Relay >", 2);
    ...
    Test3_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, RED, RED, WHITE, "Wheels >", 2);
    ...
    Button_Y = Start_Y;    
    if (Robot_Type == 1) { 
        Test4_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, MAGENTA, MAGENTA, WHITE, "Blade >", 2);
        Test4_btn.drawButton(false);
        }
    if (Robot_Type == 2) { 
        Test4_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, MAGENTA, MAGENTA, WHITE, "Drill >", 2);
        Test4_btn.drawButton(false);
        }
    ...
    Test5_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, BLUE, RED, WHITE, "Sonar >", 2);
...
// Wheel Test
 ...
 Test_Method = Robot_Type;   
    
// New Wheel Test Menu
          Menu_Complete_Wheel_Test = false;
          tft.fillScreen(BLACK);
          Serial.println(F("Wheel Test Method 2 selected"));
          Menu_Active = 65;
          ...
          while (Menu_Complete_Wheel_Test == false) {
            Sense_Button_Wheel_Test();
            React_to_Button_Wheel_Test();
            }
}
...
// Blade Motor Test
 if (Test4_btn.justPressed()) {
    ...
    if (Robot_Type == 1) {
        Serial.println(F("Blade Test starting"));
        ...
        delay(2500);
        Serial.println(F("Blade Test Finished"));
        }

    if (Robot_Type == 2) {
        Serial.println(F("Drill Test starting"));
        tft.println(F("Starting Drill Motor Test"));
        tft.println(F("Relay ON"));
        tft.println(F("DRILLS WILL SPIN"));
        tft.println(F("MIND YOUR FINGERS!!"));
        delay(7000);
        tft.println(F("Drill Motor ON"));
        delay(3000);
        tft.println(F("Drill Motor OFF"));
        delay(2500);
        Serial.println(F("Drill Test Finished"));
        }
