...
void TX_7_Data_Values() {
      ...
      delay(200); 
      SerialMEGA.print(Data1);
      SerialMEGA.println("\a");
      delay(200);  
      SerialMEGA.print(Data2);
      SerialMEGA.println("\b");
      delay(200);  
      SerialMEGA.print(Data3);
      SerialMEGA.println("\c");
      delay(200);  
      SerialMEGA.print(Data4);
      SerialMEGA.println("\d");
      delay(200);
      SerialMEGA.print(Data5);
      SerialMEGA.println("\e");
      delay(200);
      SerialMEGA.print(Data6);
      SerialMEGA.println("\f");
      delay(200);
      SerialMEGA.print(Data7);
      SerialMEGA.println("\g");
      delay(200);
